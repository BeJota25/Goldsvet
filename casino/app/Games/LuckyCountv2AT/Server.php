<?php
namespace VanguardLTE\Games\LuckyCountv2AT
{
    set_time_limit(5);
    class Server
    {
                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamePick' )
                        {
                            ...
                            if( $_POST['pick'] == 0 )
                            {
                                $slotSettings->SetGameData('LuckyCountv2ATMpl', 10);
                                $slotSettings->SetGameData('LuckyCountv2ATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LuckyCountv2ATFreeGames', 5);
                            }
                            else if( $_POST['pick'] == 1 )
                            {
                                $slotSettings->SetGameData('LuckyCountv2ATMpl', 5);
                                $slotSettings->SetGameData('LuckyCountv2ATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LuckyCountv2ATFreeGames', 10);
                            }
                            else if( $_POST['pick'] == 2 )
                            {
                                $slotSettings->SetGameData('LuckyCountv2ATMpl', 3);
                                $slotSettings->SetGameData('LuckyCountv2ATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LuckyCountv2ATFreeGames', 15);
                            }
                            else if( $_POST['pick'] == 3 )
                            {
                                $slotSettings->SetGameData('LuckyCountv2ATMpl', 2);
                                $slotSettings->SetGameData('LuckyCountv2ATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LuckyCountv2ATFreeGames', 20);
                            }
                            $response = '{"status":"success","microtime":0.0093810558319092,"dateTime":"2020-02-15 14:26:21","error":"","content":{"session":"54990161_9709e13bca7763b46396cda1868d2e7e","cmd":"gamePick","balance":' . $balanceInCents . ',"win":0,"symbols":{"1":{"1":"symbol_6","2":"symbol_9","3":"symbol_13"},"2":{"1":"symbol_10","2":"symbol_5","3":"symbol_8"},"3":{"1":"symbol_10","2":"symbol_13","3":"symbol_11"},"4":{"1":"symbol_13","2":"symbol_10","3":"symbol_6"},"5":{"1":"symbol_3","2":"symbol_8","3":"symbol_1"}},"winLines":[],"freeSpin":{"id":"54990161_20200215132548","current":0,"add":' . $slotSettings->GetGameData('LuckyCountv2ATFreeGames') . ',"total":' . $slotSettings->GetGameData('LuckyCountv2ATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('LuckyCountv2ATBonusWin') * 100) . ',"multiplayer":' . $slotSettings->GetGameData('LuckyCountv2ATMpl') . ',"pick":' . $_POST['pick'] . '},"actionId":"54990161_10_60","hash":"1ace145628d930d28bdf38789a28a9d7"}}';
                        }
                        else if( $postData['slotEvent'] == 'slotGamble' )
                        {
                            ...
                            $dealerCard = '';
                            $totalWin = $slotSettings->GetGameData('LuckyCountv2ATTotalWin');
                            $gambleWin = 0;
                            $statBet = $totalWin;
                            ...
                            $slotSettings->SetGameData('LuckyCountv2ATTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' )
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' )
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('LuckyCountv2ATBonusWin', 0);
                                $slotSettings->SetGameData('LuckyCountv2ATFreeGames', 0);
                                $slotSettings->SetGameData('LuckyCountv2ATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LuckyCountv2ATTotalWin', 0);
                                $slotSettings->SetGameData('LuckyCountv2ATFreeBalance', 0);
                                $slotSettings->SetGameData('LuckyCountv2ATMpl', 3);
                            }
                            else
                            {
                                $slotSettings->SetGameData('LuckyCountv2ATCurrentFreeGame', $slotSettings->GetGameData('LuckyCountv2ATCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('LuckyCountv2ATMpl');
                            }
                            $Balance = $slotSettings->GetBalance();
                            ...
                            if( $postData['slotEvent'] == 'freespin' )
                            {
                                $slotSettings->SetGameData('LuckyCountv2ATBonusWin', $slotSettings->GetGameData('LuckyCountv2ATBonusWin') + $totalWin);
                                $slotSettings->SetGameData('LuckyCountv2ATTotalWin', $slotSettings->GetGameData('LuckyCountv2ATTotalWin') + $totalWin);
                                $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('LuckyCountv2ATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('LuckyCountv2ATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('LuckyCountv2ATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('LuckyCountv2ATBonusWin') * 100) . '';
                            }
                            else
                            {
                                $slotSettings->SetGameData('LuckyCountv2ATTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 )
                            {
                                if( $slotSettings->GetGameData('LuckyCountv2ATFreeGames') > 0 )
                                {
                                    $slotSettings->SetGameData('LuckyCountv2ATFreeGames', $slotSettings->GetGameData('LuckyCountv2ATFreeGames') + $slotSettings->slotFreeCount[$scattersCount]);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('LuckyCountv2ATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('LuckyCountv2ATMpl') . ',"add":' . $slotSettings->slotFreeCount[$scattersCount] . ',"total":' . $slotSettings->GetGameData('LuckyCountv2ATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('LuckyCountv2ATBonusWin') * 100) . '';
                                }
                                else
                                {
                                    $slotSettings->SetGameData('LuckyCountv2ATFreeBalance', $Balance);
                                    $slotSettings->SetGameData('LuckyCountv2ATBonusWin', $totalWin);
                                    $slotSettings->SetGameData('LuckyCountv2ATFreeGames', $slotSettings->slotFreeCount[$scattersCount]);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('LuckyCountv2ATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('LuckyCountv2ATMpl') . ',"add":' . $slotSettings->slotFreeCount[$scattersCount] . ',"total":' . $slotSettings->GetGameData('LuckyCountv2ATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('LuckyCountv2ATBonusWin') * 100) . '';
                                }
                            }
                            ...
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('LuckyCountv2ATFreeGames') . ',"Mpl":' . $slotSettings->GetGameData('LuckyCountv2ATMpl') . ',"currentFreeGames":' . $slotSettings->GetGameData('LuckyCountv2ATCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":{},"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $reelStrArr = [];
                            for( $i = 1; $i <= 5; $i++ )
                            {
